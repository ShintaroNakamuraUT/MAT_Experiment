...
from .mult_discrete import MultiDiscrete
    ...
    def __init__(
        ...
        for agent in self.agents:
            ...
            if self.discrete_action_space:
                u_action_space = spaces.Discrete(world.dim_p * 2 + 1)  # 今回はこっち
            else:
            ...
            # observation space
            obs_dim = (
                len(observation_callback(agent, self.world)) + self.n
            )  # len(observation_callback(agent, self.world)) == 24 when the number of agents is 4
        ...
        ]  # len(self.share_observation_space) == 112 == 28*4 when the number of agents is 4
